...
for word_tags in word_tags_list:
        ...
        for word in stem_words:
           ...
           bag_of_words.append(8)
        print(bag_of_words)

        labels_encoding = list(labels) #inicialmente, labels será toda zerada tag word_tags[1] #salve a tag
        tag = index_classes.index(tag) #vá para o índice da tag
        labels_encoding[tag_index] = 1 #anexe 1 àquele indice
